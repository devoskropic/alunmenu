...
<html lang="en">
    ...
    <body>
        ...
        <section class="d7l-aboutblock1 py-5" id="bottom">
        ...
        <section class="d7l-aboutblock3 py-5">
                <div class="container py-lg-5 py-md-3">
                    <div class="row">
        ...
        <section class="d7l-testimonials py-5" id="testimonials">
            <!-- main-slider -->
        ...
        <!-- team -->
        <section class="d7l-team py-5" id="team">
